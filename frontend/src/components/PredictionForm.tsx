...
export default function PredictionForm({ onResult, loading, setLoading }: PredictionFormProps) {
  ...
  const testDataTemplates = {
    ...
    moderate: {
      Time: 82000, V1: -1.85, V2: -1.42, V3: 1.23, V4: 1.67,
      V5: 1.34, V6: -1.12, V7: 0.78, V8: -0.56, V9: -0.89,
      V10: -1.05, V11: -0.78, V12: -0.95, V13: 0.87, V14: -1.78,
      V15: 1.56, V16: -0.82, V17: 1.12, V18: 1.23, V19: 1.78,
      V20: -0.56, V21: 0.95, V22: 0.78, V23: 1.34, V24: -0.67,
      V25: 0.89, V26: -0.56, V27: -0.78, V28: 0.45, Scaled_Amount: 2.15
    },
    fraud: {
