...
class InferencePipeline:
    ...
    def __init__(self, model_path: str = None, config_path: str = "config/config.yaml"):
    ...
    def predict(self, transaction: Union[Dict[str, float], pd.DataFrame]) -> Dict[str, Any]:
        ...
        logger.info(
            f"Prediction: {'FRAUD' if result['is_fraud'] else 'LEGITIMATE'} "
