...
class ModelEvaluator:
    ...
    def plot_confusion_matrix(self, y_true, y_pred, model_name, save=True):
        ...
        if save:
            plt.savefig(f'{self.output_dir}{model_name}_confusion_matrix.png', dpi=150, bbox_inches='tight')
        plt.close()
    ...
    def plot_roc_curve(self, y_true, y_pred_proba, model_name, save=True):
        ...
        if save:
            plt.savefig(f'{self.output_dir}{model_name}_roc_curve.png', dpi=150, bbox_inches='tight')
        plt.close()
